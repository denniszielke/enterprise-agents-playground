...
from fastmcp.server.auth import BearerAuthProdivder
...
ENTRA_EXPECTED_AUDIENCE = os.environ.get("ENTRA_EXPECTED_AUDIENCE", "your-audience")

ENTRA_JWKS_URI = f"https://login.microsoftonline.com/{ENTRA_TENANT_ID}/discovery/v2.0/keys"
ENTRA_ISSUER = f"https://sts.windows.net/{ENTRA_TENANT_ID}/"

auth = BearerAuthProdivder(
