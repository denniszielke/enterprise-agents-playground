...
model_deployment_name = os.environ.get("REASONING_MODEL_DEPLOYMENT_NAME", os.environ["MODEL_DEPLOYMENT_NAME"])  # Ensure the MODEL_DEPLOYMENT_NAME environment variable is set
